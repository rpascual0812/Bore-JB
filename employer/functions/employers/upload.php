...
if ( !empty( $_FILES ) ) {
	...
	$dir = dirname( __FILE__ ) . DIRECTORY_SEPARATOR . '../../ASSETS/Uploads/ads/' . $additionaldir;
	if (!is_dir('../../ASSETS/Uploads/ads/' . $additionaldir)) {
    	mkdir('../../ASSETS/Uploads/ads/' . $additionaldir, 0777);
	}
    ...
    if($a){
    	$answer = array( 'answer' => 'File transfer completed', 'file' => '../ASSETS/Uploads/ads/' . $additionaldir . DIRECTORY_SEPARATOR . $newFileName );
    }
    else {
